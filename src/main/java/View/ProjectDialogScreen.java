...
public class ProjectDialogScreen extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabelToolBarTitle.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        ...
        jPanelToolBarLayout.setHorizontalGroup(
            ...
            .addGroup(jPanelToolBarLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jLabelToolBarTitle, javax.swing.GroupLayout.PREFERRED_SIZE, 154, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        try{
            if(!jTextFieldName.getText().equals("")){
                ...
                JOptionPane.showMessageDialog(rootPane, "O projeto não foi "
                        + "salvo pois o campo nome não está preenchido");
            }
        }catch (Exception e){
